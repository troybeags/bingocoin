...
!define URL http://www.bingocoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/bingocoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\bingocoin-qt.exe
...
OutFile bingocoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/bingocoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/bingocoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\bingocoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\bingocoin-qt.exe
