...
#if defined(NDEBUG)
# error "BingoCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BingoCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// bingocoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("bingocoin-loadblk");
